    ...
    <form method="POST" action="{{ url('Product/' . $product->id) }}" enctype="multipart/form-data">
        ...
        @method('PATCH')
            ...
            <div class="mb-6">
                ...
                <input class="block w-[450px] text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="user_avatar_help" type="file" name="product_image" id="product_image" value="{{ $product->product_image }}">
            </div>
